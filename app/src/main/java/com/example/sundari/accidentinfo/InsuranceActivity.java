...
public class InsuranceActivity extends AppCompatActivity {
    ...
    String insuranceCompany[] = new String[] {"Life Insurance Corporation of India (LIC)" , "ICICI Prudential Life Insurance",
            "SBI Life Insurance" , "Birla Sun Life Insurance" , "HDFC Standard Life Insurance"};
