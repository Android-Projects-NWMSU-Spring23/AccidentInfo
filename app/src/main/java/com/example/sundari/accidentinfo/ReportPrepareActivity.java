        ...
        if (validate()) {
            ...
            myRef.setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    else                        Toast.makeText(ReportPrepareActivity.this , "Failed to submit the Information" , Toast.LENGTH_SHORT).show();
                }
            });
        }
        else            Toast.makeText(this, "Please enter the required details", Toast.LENGTH_SHORT).show();
    }
